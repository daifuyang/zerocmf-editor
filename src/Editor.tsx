...
// import { CollaborationPlugin } from "@lexical/react/LexicalCollaborationPlugin"; // 协作
...
/* const skipCollaborationInit =
  window.parent != null &&
  (window as unknown as { parent: { frames: { right: Window } } }).parent.frames.right === window; */
  ...
  return (
    <div
      className={classnames({
        readonly: !isEditable,
        maximize: toolbarState.maximize
      })}
    >
