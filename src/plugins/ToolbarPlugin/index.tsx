...
const FONT_FAMILY_OBJECT: { [key: string]: string } = {
  auto: "默认",
  黑体: "黑体",
  仿宋: "仿宋",
  楷体: "楷体",
...
function FontDropDown({
  ...
  return (
    <DropDown
      ...
      buttonLabel={value ? FONT_FAMILY_OBJECT[value] : FONT_FAMILY_OBJECT["auto"]}
      buttonIconClassName={style === "font-family" ? "icon block-type font-family" : ""}
      buttonAriaLabel={buttonAriaLabel}
    >
      {(style === "font-family" ? FONT_FAMILY_OPTIONS : FONT_SIZE_OPTIONS).map(([text, option]) => (
        <DropDownItem
...
export default function ToolbarPlugin({
  ...
  const { imagePickerRender } = toolbarState;
  ...
  const $updateToolbar = useCallback(() => {
    ...
    if ($isRangeSelection(selection)) {
      ...
      updateToolbarState(
        "fontFamily",
        $getSelectionStyleValueForProperty(selection, "font-family", "auto")
      );
      let matchingParent;
  ...
  const imagePicker = imagePickerRender?.({
    ...
    <>
      ...
      <div className="toolbar">
            ...
            >
              ...
              >
                <div className="icon-text-container">
                  ...
                  <span className="text">首字母大写</span>
                </div>
        ...
        <button
          disabled={!isEditable}
          onClick={() => {
            updateToolbarState("maximize", !toolbarState.maximize);
          }}
          className={"toolbar-item spaced "}
          title={toolbarState.maximize ? `Minimize` : `maximize`}
          type="button"
          aria-label={`maximize`}
        >
          {toolbarState.maximize ? (
            <i className="format minimizeIcon" />
          ) : (
            <i className="format maximizeIcon" />
          )}
        </button>
